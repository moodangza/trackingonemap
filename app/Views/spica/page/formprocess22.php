                    ...
                    <div class="form-horizontal form-input">
                        <div class="row">
                            <div class="col-12 col-md-12 col-xl-12">
                                <div class="form-group row">
                                    ...
                                    <label class="col-12 col-md-12 col-xl-12 col-form-label text-center"> <h3><?php echo $job["job_name"];?></h3>  </label>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-xl-6">
                                <div class="form-group row">
                                    ...
                                    <label class="col-8 col-md-8 col-xl-8 col-form-label text-left"><?php echo $job["job_start"]; ?></label>
                                    <input  type="hidden" readonly id='s_job' value="<?php //echo $job["job_startpic"]; ?>">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-12 col-md-12 col-xl-6">
                                <div class="form-group row">
                                    ...
                                    <input  type="hidden" readonly id='e_job' value="<?php //echo $job["job_endpic"]; ?>">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="card">
                               ...
                               <div class="row">
                                <div class="col-12 col-md-12 col-xl-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" autocomplete="off" id="process_name" name="process_name" class="form-control" placeholder="เรื่อง" value="<?php echo $process['process_name'];?>" required="">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group date">
                                                ...
                                                name="s_date" data-old="" value="<?php echo $process["process_start"];?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group date">
                                                ...
                                                name="e_date" data-old="" value="<?php echo $process["process_end"];?>">
                                                <div class="input-group-append">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3">รายละเอียด  <?php echo $flag;?></label>
                                        <div class="col-md-9">

                                        <div class="form-floating">
                                          
                                            <textarea autocomplete="off" class="form-control" placeholder="Leave a comment here" id="detail" name="detail" style="height: 100px"><?php echo $process["detail"];?></textarea>
