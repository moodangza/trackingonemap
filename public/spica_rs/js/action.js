...
function showsubprocess() {
  ...
  $.ajax({
    ...
    success: function (data) {
      let a = JSON.parse(data);
      console.log(a)   
      $('#subprocess_id').val(a.subprocess_id);
    }
  });
  $('#processitem').html('');
...
function editjob() {
  ...
  $.ajax({
    ...
    dataType: 'text',
    data: {
      editjobid: editjob_id,
      editjobname: editjobname,
      editjobstart: editjstart,
      editjobend: editjend
    },
    success: function (data) {
      alert('บันทึก')
...
$(document).on("click", ".updatesubprocess", function () {
  ...
  $.ajax({
    ...
    data: {
      sub_id: subid,
      subprocess_name: subinput,
      subprocess_start: substart,
      subprocess_end: subend
    },
    success: function (data) {
      location.reload();
    }
